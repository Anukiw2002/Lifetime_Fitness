...
<head>
    ...
    <%--<link rel="stylesheet" href="${pageContext.request.contextPath}/css/library/reset.css">--%>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/library/forms.css">
