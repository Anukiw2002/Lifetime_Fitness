...
<div class="main-content">
    <div class="container">
        <div class="card">
            ...
            <form action="${pageContext.request.contextPath}/editInstructor" method="post" enctype="multipart/form-data">
                ...
                <div class="form-actions flex justify-between">
                    <!-- Place the deactivate button on the left -->
                    <div>
                        <button type="button" id="toggleStatusBtn" class="btn btn-danger">
                            ${instructor.isActive ? 'Deactivate' : 'Activate'} Instructor
                        </button>
                    </div>

                    <div class="flex gap-md">
                        <a href="${pageContext.request.contextPath}/viewInstructor?id=${instructor.userId}" class="btn btn-secondary">Cancel</a>
                        <button type="submit" class="btn btn-primary">Save Changes</button>
                    </div>
                </div>
            </form>

            <form id="toggleStatusForm" action="${pageContext.request.contextPath}/toggleInstructorStatus" method="get" style="display: none;">
...
<script>
    ...
    // Toggle instructor status form submission
